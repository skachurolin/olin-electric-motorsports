...
RTD_BUTTON_LED = 13
PROGRAMMING_LED_1 = 21
PROGRAMMING_LED_2 = 20
PROGRAMMING_LED_3 = 26
...
GPIO.add_event_detect(BOTS_SHDN_SENSE, GPIO.BOTH, callback=shutdown_callback)
GPIO.add_event_detect(E_STOP_SHDN_SENSE, GPIO.BOTH, callback=shutdown_callback)
